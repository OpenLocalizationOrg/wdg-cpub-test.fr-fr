...
To learn more about configuring languages in your apps, see [Guidelines for globalization and localization](https://msdn.microsoft.com/library/windows/apps/hh969150) and [How to manage language and region](https://msdn.microsoft.com/library/windows/apps/xaml/hh967761). We also have a [Multilingual App Toolkit](https://msdn.microsoft.com/library/windows/apps/xaml/jj572370) to help you write apps that support multiple languages.

For a list of localized Windows Store terms, see [Windows Store app marketing guidelines](app-marketing-guidelines.md).
